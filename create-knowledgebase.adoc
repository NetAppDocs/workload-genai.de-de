...
.. *Chat-Modell*: Wählen Sie zwischen Anthropic Claude oder Amazon Nova Chat-Modellen, die in Amazon Bedrock integriert sind. Beachten Sie, dass Sie das Chatmodell von Amazon Bedrock bereits aktiviert haben müssen.
+
Erfahren Sie mehr über die Verwendung dieser Modelle mit Amazon Bedrock:
