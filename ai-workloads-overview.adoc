...
---
= Erfahren Sie mehr über die Workload-Fabrik für GenAI
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
== Was ist die Workload-Fabrik für GenAI?
...
Die Workload-Farm für GenAI vereinfacht die Implementierung von Infrastrukturen, die für die Erstellung generativer KI-Applikationen mithilfe von Retrieval Augmented Generation (RAG) erforderlich sind. Im Detail bietet GenAI folgende Vorteile:
...
== Wie die Workload-Fabrik für GenAI zum Erstellen generativer KI-Applikationen hilft
